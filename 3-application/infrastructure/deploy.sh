...
SERVICE_TAG="v1"
ECR_REPO_URL="123456789.dkr.ecr.ap-south-1.amazonaws.com/${SERVICE_NAME}"
...
if [ "$1" = "build" ]; then
  ...
  terraform plan -var-files="production.tfvars" -var "docker_image_url=${ECR_REPO_URL}:${SERVICE_TAG}"
